      ...
      <div class="col-md-12">
        <div class="for-group text-center">
          <div style="margin-bottom: 12px;">
            <span style="display: inline-flex; align-items: center; gap: 8px; padding: 8px 20px; background: linear-gradient(135deg, #1a6dff 0%, #0041b8 100%); border-radius: 8px; color: #fff; font-size: 22px; font-weight: 700; letter-spacing: 1px;">
              <svg width="28" height="28" viewBox="0 0 24 24" fill="none"><rect width="24" height="24" rx="6" fill="#fff" fill-opacity=".18"/><path d="M7 12l3 3 7-7" stroke="#fff" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"/></svg>
              Kora Pay
            </span>
          </div>
          <p class="p-t-5"><small><?=sprintf(lang("you_can_deposit_funds_with_paypal_they_will_be_automaticly_added_into_your_account"), 'Kora Pay')?></small></p>
        </div>
        ...
        <div class="form-group">
          ...
          <ul>
            ...
            <?php } ?>
            <li>You will be redirected to Kora Pay's secure checkout to complete payment.</li>
          </ul>
        </div>
        ...
        <div class="form-actions left">
          ...
          <button type="submit" class="btn btn-primary btn-lg btn-block" style="background: linear-gradient(135deg, #1a6dff, #0041b8); border: none; border-radius: 8px; font-weight: 600;">
            <i class="fa fa-lock"></i> <?=lang("Pay")?> with Kora Pay
          </button>
        </div>
      </div>
    </div>
