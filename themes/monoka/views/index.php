                            ...
                            <form class="actionFormWithoutToast" action="<?=cn("auth/ajax_sign_in")?>" data-redirect="<?=cn('home')?>" method="POST">
                                ...
                                <div class="form-group" style="text-align:center;">
                                    <div style="position:relative; display:flex; align-items:center; justify-content:center; margin:8px 0 4px;">
                                        ...
                                        <span style="padding:0 12px; color:rgba(255,255,255,0.7); font-size:13px;">or</span>
                                        <div style="flex:1; height:1px; background:rgba(255,255,255,0.3);"></div>
                                    </div>
                                    <a href="<?=cn('auth/google_login')?>" class="btn-google-signin" style="display:inline-flex; align-items:center; justify-content:center; gap:10px; width:100%; padding:10px 20px; background:#fff; color:#444; border-radius:6px; font-size:14px; font-weight:500; text-decoration:none; transition:box-shadow 0.2s,transform 0.1s; box-shadow:0 2px 8px rgba(0,0,0,0.15); margin-top:10px;">
